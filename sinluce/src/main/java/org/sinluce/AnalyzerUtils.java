...
public class AnalyzerUtils {
  ...
  public static void displayTokens(Analyzer analyzer,
    ...
    displayTokens(analyzer.tokenStream("valor", new StringReader(text)));  //A
  }
  ...
  */
  ...
  public static String displayTokensWithPositions
    (Analyzer analyzer, String text) throws IOException {

    TokenStream stream = analyzer.tokenStream("valor",
  ...
  public static void displayTokensWithFullDetails(Analyzer analyzer,
    ...
    TokenStream stream = analyzer.tokenStream("valor",                        // #A
                                              new StringReader(text));
  ...
  public static void displayPositionIncrements(Analyzer analyzer, String text)
    throws IOException {
    TokenStream stream = analyzer.tokenStream("valor", new StringReader(text));
    PositionIncrementAttribute posIncr = stream.addAttribute(PositionIncrementAttribute.class);
    while (stream.incrementToken()) {
